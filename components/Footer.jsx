      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="text-sm text-gray-400 space-y-2">
            <p>123 High Street, Indiranagar</p>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" className="w-10 h-10 rounded-full bg-light-bg/10 flex items-center justify-center hover:bg-gold hover:text-primary-dark transition text-white">
